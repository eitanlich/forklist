...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  rating_food SMALLINT NOT NULL CHECK (rating_food BETWEEN 1 AND 10),
  rating_service SMALLINT NOT NULL CHECK (rating_service BETWEEN 1 AND 10),
  rating_ambiance SMALLINT NOT NULL CHECK (rating_ambiance BETWEEN 1 AND 10),
  rating_price SMALLINT NOT NULL CHECK (rating_price BETWEEN 1 AND 10),
  comment TEXT,
