...
### Pendientes
- [ ] **Follow system no funciona** — debuggear flujo completo (botón → server action → DB)
- [ ] **Buscar usuarios por email** — username es opcional, necesitamos poder encontrar gente por email también
